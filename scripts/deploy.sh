cd /home/ubuntu/app       # app/step3 디렉토리를 직접 만들었습니다
echo "> 복사좀 되어라 !!!" >> /home/ubuntu/app/deploy.log
BUILD_JAR=$(ls *.jar)
...
nohup java -jar $DEPLOY_JAR >> /home/ubuntu/app/deploy.log 2>/home/ubuntu/deploy_err.log &